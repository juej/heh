...
//    }
    ...
    public void delete(long orderItemId) {
        try (Connection connection = dataSource.getConnection()) {
            ...
            PreparedStatement ps = connection.prepareStatement("DELETE FROM orderitem WHERE orderitem_id = ?");
    ...
    public void insert(long orderItemId, long orderId, long productId, double unitPrice, long quantity) {
        try (Connection connection = dataSource.getConnection()) {
